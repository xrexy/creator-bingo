export type YouTubeActivityProps = {
  width?: number;
  height?: number;
  className?: string;
};

export function YouTubeActivity({
  height = 32,
  width = 32,
  className,
}: YouTubeActivityProps) {
  return (
    <svg
